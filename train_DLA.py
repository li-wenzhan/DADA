...
def main(args):
    ...
    data_path = r'/data/lwz010/Files/VScodeProjects/DADA-master/datasets/' + args.subset
    ...
    while t < args.num_iterations:
        ...
        for index_batch in range(len_max):
            ...
            if t > 0 and t % args.save_checkpoint_every == 0:
                ...
                checkpoint_path = os.path.join(args.output_dir, 'tools', 'DLA', args.checkpoint_name,
    ...
    target_traj_fake_list = []
    seq_start_end_s_list = []
    ...
    txt_save_path = r'/data/lwz010/Files/VScodeProjects/DADA-master/datasets/' + args.subset
