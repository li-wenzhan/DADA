...
def main():
    ...
    args.conf = os.getcwd() + '/tools/FLA/config/config.json'
    ...
    log_writer = None
    model_dir = None
    args.log_dir = os.getcwd() + '/tools/FLA/experiments/saved_models'
    if not args.debug:
    ...
    train_scenes = []
    args.data_dir_transfer = os.getcwd() + '/tools/FLA/experiments/processed_data'
