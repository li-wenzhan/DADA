...
sys.path.append("tools/FLA/trajectron")
...
if __name__ == "__main__":
    eval_path = os.getcwd() + '/tools/FLA/experiments/pedestrian/results/' + args.subset + '_ade_best_of.csv'
    if not os.path.exists(eval_path):
        ######### Test #########
        args.data = os.getcwd() + '/tools/FLA/experiments/processed_data/' + args.subset + '_test.pkl'
        with open(args.data, 'rb') as f:
            env = dill.load(f, encoding='latin1')

        args.model = os.getcwd() + '/tools/FLA/experiments/saved_models/' + args.subset + '_models'
        ...
        with torch.no_grad():
            ...
            args.output_path = os.getcwd() + '/tools/FLA/experiments/pedestrian/results'
    ...
    for dataset in dataset_names:
        result_path = os.getcwd() + '/tools/FLA/experiments/pedestrian/results/{}_ade_best_of.csv'.format(dataset)
    ...
    perf_df = pd.DataFrame()
    for dataset in dataset_names:
        result_path = os.getcwd() + '/tools/FLA/experiments/pedestrian/results/{}_fde_best_of.csv'.format(dataset)
        for f in glob.glob(result_path):
            dataset_df = pd.read_csv(f)
            dataset_df['dataset'] = dataset
            dataset_df['method'] = alg_name
